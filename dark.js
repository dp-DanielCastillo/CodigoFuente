...
k = modes.length;
for (j = 0; j < k; j++) {
    x = document.getElementsByClassName(modes[j] + "-dark");
    l = x.length;
    for (i = 0; i < l; i++) {
...
function codeColorize(x, lang) {
  ...
  /* HTML Colors */
  var tagcolor = "#A3A3A3";
  var tagnamecolor = "#019875";
  var attributecolor = "#FFF74D";
  var attributevaluecolor = "#DFC38A";

  /* Comment Colors */ 
  var commentcolor = "#C3C3C3";

  /* CSS Colors */
  var cssselectorcolor = "#DFC38A";
  var csspropertycolor = "#5A657E";
  var csspropertyvaluecolor = "#FF547F";
  ...
  /* PHP Colors */
  var phptagcolor = "#FF547F";
  var phpcolor = "#818181";
  var phpkeywordcolor = "#368E04";
  var phpglobalcolor = "goldenrod";
  var phpstringcolor = "#AE9055";
  var phpnumbercolor = "#019875";

  /* Angular Color  */ 
  var angularstatementcolor = "#940000";
  ...
  function htmlMode(txt) {
    ...
    php = new extract(rest, "&lt;\\?php", "?&gt;", phpMode, "M3PHPPOS");
    rest = php.rest;
    comment = new extract(rest, "&lt;!--", "--&gt;", commentMode, "M3HTMLCOMMENTPOS");
    rest = comment.rest;
    ...
    for (i = 0; i < comment.arr.length; i++) {
        rest = rest.replace("M3HTMLCOMMENTPOS", comment.arr[i]);
    }
    for (i = 0; i < php.arr.length; i++) {
        rest = rest.replace("M3PHPPOS", php.arr[i]);
    }
    return rest;
  }
  ...
  function getKeywordPos(typ, txt, func) {
    ...
    if (typ == "js") {
      ...
      "super","switch","synchronized","this","throw","throws","transient","true","try","typeof","var","void","volatile","while","with","yield","alert",
      "write","confirm"];
    } else if (typ == "php") {
